function [beta,sigma,omega,h0,htilde,scale,p] = svo_uniform(y,x,sigma,htilde,beta0,iVbeta0,h0,omega,scale,p,priors,stability,ident)
...
[ind,S] = draw_lcs_indicators(e_scaled,sigma',r_p,r_m,r_s);
