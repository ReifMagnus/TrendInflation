...
if SV == 1
    ...
    prior.sv.Vh         = 1;                % initial variance of h_1
    prior.sv.Vomegah    = .2;               % omega_h ~ N(0,omegah2) --> std. dev. of sv process, implied mean: 0.5/(1/2*Vomegah)
    prior.sv_trend      = prior.sv;    
    
    % Parameters for scale mixture of epsilon component    
    freq                  = 4;                                               % 4: quarterly data
    prior.sv.scl_eps_vec  = (1:7)';                                          % draw from a 7-point grid
